...
define( 'CHAT_HACK_ATTEMPT', 'Неверные параметры. Хак? За тобой уже выехал Kaby xD' );

// сообщения автомодерации
define( 'CHAT_AM_NOT_CITIZEN', 'C момента регистрации прошло недостаточно времени или есть бан(ы) в чате, но он(и) недопустимы для получения статуса гражданина.' );
define( 'CHAT_NO_BANS_FOR_ADOLF_TO_MAIN', 'Граждане SC2TV.RU забанили бы Адольфа, но демократия кончилась.' );
define( 'CHAT_NO_BANS_FOR_ADOLF_TO_USER', 'У тебя почти получилось. Но Адольф не желает быть забаненным.' );
